            ...
            <td align="center" valign="top"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="margin-top:15px">
                    <tbody>
                        ...
                        <tr>
                            <td align="center" valign="bottom" id="m_591777913139846361m_186734553970362782headerImage">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h1
                                                    ...
                                                    Đơn hàng đã sẵn sàng để giao đến quý khách!</h1>
                                                <h2>Trạng thái: <span style="color: red">Đang xử lí</span></h2>
                                                <p
                                        ...
                                        <tr>
                                            <th colspan="4"
                                                style="text-align:left;background-color:rgb(2,172,234);padding:6px 9px;color:#fff;text-transform:uppercase;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px">
                                                Tổng tiền thanh toán: <span style="color:red">{{Cart::total()}}đ</span></th>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <tr>
                            <td>
                                ...
                                <p
                                    ...
                                    Liên hệ Hotline
                                    <strong style="color:#099202">0916743545</strong>
                                    (8-21h cả T7,CN).
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <p
                                    ...
                                    <span>[LVP] Vietnam</span> cảm ơn quý khách,<br>
                                </p>
                                <p
